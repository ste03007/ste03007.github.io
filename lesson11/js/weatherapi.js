...
fetch(apiURL)
  ...
  let tempF =  document.main.temp; // in the future this will be replaced with data from a third party - openweathermap
  let windSpeed = document.wind.speed; // will be replaced as well
